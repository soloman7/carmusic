...
- **车载音乐 CarMusic**：为 BYD 元 PLUS 车机（DiLink / Android 10+）设计的聚合音乐播放 APK。当前版本 v3.5.1。

## 特性

- **7 平台聚合搜索**：网易云 / QQ 音乐 / 酷狗 / 酷我 / 咪咕 / Jamendo 免费电台 / 猫耳FM
- **网络电台（v3.5）**：RadioBrowser 全球 5 万台库 local-first 内置（中国 2,300+ 台 + 全球热门 1,000 台离线可用），收藏/本省（GPS 推荐）/搜索三屏，LIVE 收听条带流量估算，方向盘盲操作友好（驾驶模式大按钮 M2）
